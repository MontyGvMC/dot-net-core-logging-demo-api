using DotNetCoreLoggingDemoAPI.Scenario1.Models;
...
namespace DotNetCoreLoggingDemoAPI.Scenario1.Controllers
{
    ...
    //[ApiController]
    public class Scenario1Controller : ControllerBase
    {

        /// <summary>
        /// Our in memory data collection (for the sake of simpleness).
        /// </summary>
        private static IDictionary<int, Scenario1Model> _data = new Dictionary<int, Scenario1Model>();
        ...
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(Scenario1Model[]))]
        ...
        [Produces("application/json")]
        [ProducesResponseType(StatusCodes.Status201Created, Type = typeof(Scenario1Model))]
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        public IActionResult PostModel([FromBody] Scenario1RequestModel request)
        {
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        public IActionResult PutModel(int id, [FromBody] Scenario1RequestModel request)
        {
