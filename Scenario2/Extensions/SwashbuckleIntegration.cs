            ...
            (
                options =>
                {
                    ...
                    (
                        ...
                        {
                            Version = "v1",
                            Title = ".NET Core Logging Demo API: Scenario 2",
                            Description = "A playground for .NET Core logging experiments. A basic in-memory CRUD controller with some logging."
                        }
                    );
                }
            );
